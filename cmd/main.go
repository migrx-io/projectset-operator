...
import (
	...
	"github.com/migrx-io/projectset-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f5f77c93.migrx.io",
		//ClientDisableCacheFor:  []client.Object{&projectv1alpha1.ProjectSetTemplate{}},
	...
	if err = (&controller.ProjectSetReconciler{
		Client:   mgr.GetClient(),
		Scheme:   mgr.GetScheme(),
		Recorder: mgr.GetEventRecorderFor("projectset-controller"),
